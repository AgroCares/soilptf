#' # Old scripts of aggregating function of different ptf's (made by Gerard) are temporarily saved.
#' 
#' 
#' # predict function
#' 
...
#' #' 
#' #' @export
#' ptf_bd_old2 <- function(A_SOM_LOI = NA_real_, A_C_OF = NA_real_, 
...
#'   dt[ptf_id==25, value := sptf_bd25(A_C_OF = A_C_OF, A_CLAY_MI = A_CLAY_MI,A_SILT_MI = A_SAND_MI,A_H2O_T105 = A_H2O_T105, A_DEPTH = A_DEPTH)]
#'   dt[ptf_id==26, value := sptf_bd26(A_SOM_LOI = A_SOM_LOI)]
#'   dt[ptf_id==27, value := sptf_bd27(A_SOM_LOI = A_SOM_LOI)]
#'   dt[ptf_id==28, value := sptf_bd28(A_SAND_MI = A_SAND_MI, A_DEPTH = A_DEPTH)]
#'   dt[ptf_id==29, value := sptf_bd29(A_C_OF = A_C_OF, A_SAND_MI = A_SAND_MI,A_DEPTH = A_DEPTH)]
...
#'   dt[ptf_id==39, value := sptf_bd39(A_C_OF = A_C_OF,A_CLAY_MI = A_CLAY_MI,A_H2O_T105 = A_H2O_T105,A_DEPTH = A_DEPTH)]
#'   dt[ptf_id==40, value := sptf_bd40(A_SOM_LOI = A_SOM_LOI,A_SAND_MI = A_SAND_MI,A_DEPTH = A_DEPTH)]
...
#'   dt[ptf_id==69, value := sptf_bd69(A_CLAY_MI = A_CLAY_MI,A_DEPTH = A_DEPTH)]
#'   dt[ptf_id==70, value := sptf_bd70(A_C_OF = A_C_OF,A_CLAY_MI=A_CLAY_MI, A_SILT_MI=A_SILT_MI, A_DEPTH=A_DEPTH, B_ALTITUDE=B_ALTITUDE, B_SLOPE_DEGREE=B_SLOPE_DEGREE, B_SLOPE_ASPECT=B_SLOPE_ASPECT)]
...
#'   dt[ptf_id==105, value := sptf_bd105(A_C_OF = A_C_OF, A_DEPTH = A_DEPTH)]
#'   dt[ptf_id==106, value := sptf_bd106(A_C_OF = A_C_OF, A_DEPTH = A_DEPTH)]
#'   dt[ptf_id==107, value := sptf_bd107(A_C_OF = A_C_OF, A_DEPTH = A_DEPTH)]
#'   dt[ptf_id==108, value := sptf_bd108(A_C_OF = A_C_OF, A_DEPTH = A_DEPTH)]
#'   dt[ptf_id==109, value := sptf_bd109(A_C_OF = A_C_OF, A_DEPTH = A_DEPTH)]
#'   dt[ptf_id==110, value := sptf_bd110(A_C_OF = A_C_OF, A_DEPTH = A_DEPTH)]
...
#'   dt[ptf_id==126, value := sptf_bd126(A_C_OF = A_C_OF, A_SILT_MI = A_SILT_MI, A_DEPTH = A_DEPTH)]
#'   dt[ptf_id==127, value := sptf_bd127(A_C_OF = A_C_OF, A_DEPTH = A_DEPTH)]
#'   dt[ptf_id==128, value := sptf_bd128(A_C_OF = A_C_OF)]
#'   dt[ptf_id==129, value := sptf_bd129(A_C_OF = A_C_OF, A_CLAY_MI = A_CLAY_MI, A_SILT_MI = A_SILT_MI,A_DEPTH = A_DEPTH)]
...
#'   dt[ptf_id==133, value := sptf_bd133(A_C_OF = A_C_OF, A_DEPTH = A_DEPTH, B_SLOPE_DEGREE = B_SLOPE_DEGREE)]
...
#'   dt[ptf_id==137, value := sptf_bd137(A_SOM_LOI = A_SOM_LOI,A_SILT_MI = A_SILT_MI,A_PH_WA = A_PH_WA,A_DEPTH = A_DEPTH)]
...
#'   dt[ptf_id==147, value := sptf_bd147(A_C_OF = A_C_OF,A_CLAY_MI = A_CLAY_MI,A_SAND_MI = A_SAND_MI,A_SILT_MI = A_SILT_MI,A_DEPTH = A_DEPTH)]
#'   dt[ptf_id==148, value := sptf_bd148(A_SOM_LOI = A_SOM_LOI,A_CLAY_MI = A_CLAY_MI)]
#'   dt[ptf_id==149, value := sptf_bd149(A_C_OF = A_C_OF)]
#'   dt[ptf_id==150, value := sptf_bd150(A_C_OF = A_C_OF,A_DEPTH = A_DEPTH)]
